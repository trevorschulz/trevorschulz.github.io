...
let background = document.getElementById("background");
        if (wind_mph >= 10){
            ...
            background.innerHTML = "<style> body{background-image:url('https://trevorschulz.github.io/images/plan-images/rainy.gif')}</style>";
        }
        else if (observation == "Snow"){
            background.innerHTML = "<style> body{background-image:url('https://trevorschulz.github.io/images/plan-images/snowy.gif')}</style>";
        }
       else if (observation == "Overcast" || observation == "Mostly Cloudy" || observation == "Scattered Clouds" || observation == "Partly Cloudy"){
            background.innerHTML = "<style> body{background-image:url('https://trevorschulz.github.io/images/plan-images/cloudy.gif')}</style>";
        }
      else {
